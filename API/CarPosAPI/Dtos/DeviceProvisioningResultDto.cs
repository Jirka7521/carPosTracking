...
/// <param name="AckTopic">Topic the API confirms stored fixes on.</param>
...
/// SHA-256 of the device's imported <em>ack</em> public key (uppercase hex), or null
/// when none has been imported and the device therefore receives no delivery acks.
/// A fingerprint only — the matching private key is generated off-server and lives
/// solely in the firmware's git-ignored <c>Config.h</c>, which is what keeps the
/// no-secret guarantee above true for the ack direction as well.
/// </param>
