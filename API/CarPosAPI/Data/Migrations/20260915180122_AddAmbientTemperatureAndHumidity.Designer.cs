...
namespace CarPosAPI.Data.Migrations
{
    ...
    [Migration("20260915180122_AddAmbientTemperatureAndHumidity")]
    partial class AddAmbientTemperatureAndHumidity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarPosAPI.Data.Entities.Device", b =>
                {
                    ...
                    b.Property<DateTime?>("TrackingDeclarationAcceptedAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("CarPosAPI.Data.Entities.Position", b =>
                {
                    ...
                    b.Property<double?>("AmbientTemperatureC")
                        .HasColumnType("double precision")
                    ...
                    b.ToTable("positions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_positions_ambient_temperature_c", "ambient_temperature_c >= -40 AND ambient_temperature_c <= 80");

                            t.HasCheckConstraint("ck_positions_battery_pct", "battery_pct >= 0 AND battery_pct <= 100");

                            t.HasCheckConstraint("ck_positions_humidity_pct", "humidity_pct >= 0 AND humidity_pct <= 100");
            ...
            modelBuilder.Entity("CarPosAPI.Data.Entities.ShareLink", b =>
                {
                    ...
                    b.Property<bool>("IncludeBattery")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
